...
public class AuthController {
    ...
    @PostMapping("/sign-up")
    public UserLoginDto signUp(@ModelAttribute UserCreateDTO userCreateDTO) throws BusinessRuleException {
    	
    	UserCreateDTO createUser = userService.createUser(userCreateDTO, userCreateDTO.getProfileImage());
