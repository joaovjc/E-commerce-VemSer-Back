...
public class AuthController {
    ...
    @PostMapping("/sign-up")
    public UserLoginDto signUp(@Valid @ModelAttribute(name = "data", binding = true) CreateUserDTO CreateDTO, BindingResult bindingResult) throws BusinessRuleException {
