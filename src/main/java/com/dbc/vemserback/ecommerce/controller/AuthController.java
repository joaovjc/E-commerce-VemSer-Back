...
public class AuthController {
    ...
    public UserLoginDto signUp(@Valid @ModelAttribute(name = "data", binding = true) CreateUserDTO createDTO, @RequestPart(name = "file",required = false) MultipartFile file, BindingResult bindingResult) throws BusinessRuleException {
